...
export _SW2INSTALL="$_SW2INSTALL mplayer gnome-mplayer gecko-mediaplayer gphoto2 parted gparted"
...
export _SW2INSTALL="$_SW2INSTALL gutenprint-locales ooo2dbk gutenprint-doc unpaper realvnc-vnc-server"
export _SW2INSTALL="$_SW2INSTALL realvnc-vnc-viewer hdparm nfs-kernel-server nfs-common autofs fail2ban ntfs-3g"
...
export _SW2INSTALL="$_SW2INSTALL libxslt-dev libcairo2 libgeos++-dev libgeos-dev libgeos-doc libjpeg-dev libtiff5-dev"
