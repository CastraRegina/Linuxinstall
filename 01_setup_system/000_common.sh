...
export _SW2INSTALL="$_SW2INSTALL python3-gps python-gobject-2-dbg python-gtk2-doc devhelp python-gdbm-dbg python-tk-dbg"
export _SW2INSTALL="$_SW2INSTALL iw wpasupplicant wireless-tools python3-pil.imagetk moreutils"
export _SW2INSTALL="$_SW2INSTALL libavformat-dev python-pil-doc python-pil.imagetk-dbg python-doc python-examples"
export _SW2INSTALL="$_SW2INSTALL libjpeg-turbo8 libjpeg-turbo8-dev libavcodec-dev libc6-dev"
...
export _SW2INSTALL="$_SW2INSTALL gutenprint-locales ooo2dbk gutenprint-doc unpaper pdfposter texlive-extra-utils"
export _SW2INSTALL="$_SW2INSTALL hdparm nfs-kernel-server nfs-common autofs fail2ban ntfs-3g flatpak"
...
export _SW2INSTALL="$_SW2INSTALL system-config-printer autotrace enscript gnuplot grads graphviz"
...
export _SW2INSTALL="$_SW2INSTALL usb-creator-gtk software-properties-common apt-transport-https wget curl libpam-mount"
export _SW2INSTALL="$_SW2INSTALL baobab gdebi-core retext dosfstools ssvnc krdc keepassxc oathtool wakeonlan"
export _SW2INSTALL="$_SW2INSTALL openssh-server fdupes rename imagemagick imagemagick-doc"
